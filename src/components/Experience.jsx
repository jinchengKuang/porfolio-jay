...
const Experience = () => {
	return (
		<div className='container flex justify-center mx-auto my-5 max-w-5xl'>
			<ol className='relative mt-16 border-l border-b border-gray-200 dark:border-gray-700'>
				{/* work experience 1 */}
				...
				<li className='mb-10 ml-6'>
					...
					<ul className='translate-x-5'>
						...
						<li className='mb-4 text-base font-normal text-gray-500 dark:text-gray-400 max-w-2xl list-disc translate-x-4'>
							Established integrated dashboards to parse system machine data and
							generate reports more efficiently in Splunk , saving manual
